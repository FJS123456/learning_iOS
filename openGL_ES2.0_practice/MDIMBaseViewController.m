...
@interface MDIMBaseViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MDIMBaseViewController
...
- (void)configData
{
    ...
    [dict1 setObject:@"MDSocketClient_001" forKey:kClassName];
    [dict1 setObject:@"原生socket_001" forKey:kTitleName];
    
    NSMutableDictionary *dict2 = [NSMutableDictionary dictionary];
    [dict2 setObject:@"MDGCDAsyncSocketController" forKey:kClassName];
    [dict2 setObject:@"GCDAsyncSocket源码剖析" forKey:kTitleName];
