...
@interface MDMetalBaseController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MDMetalBaseController
...
- (void)configData
{
    ...
    [dict1 setObject:@"MDMetalFramework_001" forKey:kClassName];
    [dict1 setObject:@"metal框架学习_001" forKey:kTitleName];
