...
#pragma mark - GLKEffectPropertyTexture category
...
#pragma mark - OpenGLES_ch3_6

@interface OpenGLES_ch3_6 ()
...
- (BOOL)loadShaders
{
    ...
    vertShaderPathname = [[NSBundle mainBundle] pathForResource:@"Shader3_6" ofType:@"vsh"];
    if (![self compileShader:&vertShader type:GL_VERTEX_SHADER file:vertShaderPathname]) {
        NSLog(@"Failed to compile vertex shader");
        return NO;
    }
    
    fragShaderPathname = [[NSBundle mainBundle] pathForResource:@"Shader3_6" ofType:@"fsh"];
