...
//fragment shader
NSString *const kGPUImageBeautyfyFragmentShaderString = SHADER_STRING
(
...
- (id)init
{
    if (self = [super initWithFragmentShaderFromString:kGPUImageBeautyfyFragmentShaderString]) {
