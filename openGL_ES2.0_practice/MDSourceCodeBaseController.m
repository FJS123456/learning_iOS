...
@interface MDSourceCodeBaseController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MDSourceCodeBaseController
...
- (void)configData
{
    ...
    [dict1 setObject:@"MDObjection_001" forKey:kClassName];
    [dict1 setObject:@"依赖注入——Objection" forKey:kTitleName];
