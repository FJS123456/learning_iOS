//
//  MDAVFoundationBaseController.m
//  openGL_ES2.0_practice
//
//  Created by 符吉胜 on 2017/10/23.
//  Copyright © 2017年 符吉胜. All rights reserved.
//

#import "MDAVFoundationBaseController.h"

const static NSString * const kClassName = @"kClassName";
const static NSString * const kTitleName = @"kTitleName";

@interface MDAVFoundationBaseController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MDAVFoundationBaseController
